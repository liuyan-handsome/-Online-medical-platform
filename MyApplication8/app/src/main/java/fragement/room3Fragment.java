 ...
 * Use the {@link room3Fragment#newInstance} factory method to
...
public class room3Fragment extends Fragment {
     ...
     * @return A new instance of fragment room3Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static room3Fragment newInstance(String param1, String param2) {
        room3Fragment fragment = new room3Fragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Button btn_pickup2 = (Button) getActivity().findViewById(R.id.btn_wangdoctor);
        ...
        Button btn_pickup3 = (Button) getActivity().findViewById(R.id.btn_liudoctor);
        btn_pickup2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(intent_information);
